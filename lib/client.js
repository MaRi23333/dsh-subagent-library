	...
	*  commits our state. Pushes in this window are skipped and re-run after. */
	...
	const applyWrite = async (write, touchedId) => {
		...
		try {
			...
			skippedWhilePending.current = false;
			if (result.conflict) {
				if (result.view !== void 0) {
					setView(result.view);
					setEntries(structuredClone(result.view.entries));
				} else load();
				setStatus({
					kind: "error",
					text: "名册已被其他窗口或外部修改，已加载最新内容，请重试。"
				});
			} else {
				if (skipped) load();
				setStatus({
	...
	if (view === null) return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			status !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				style: status.kind === "ok" ? okBannerStyle : errorBannerStyle,
		...
		children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					style: subStyle,
					children: [
						"管理具名角色子代理（每条目一个 YAML 文件，保存即热生效）。让 agent 修改条目前，建议先把原文件复制到名册目录的 ",
			...
			(view.diagnostics?.length ?? 0) > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				children: view.diagnostics.map((item, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					style: {
						...
						opacity: item.severity === "info" ? .75 : 1
					},
					children: [
			...
			ids.length === 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				style: subStyle,
				children: "库为空。添加第一个条目开始使用，或在名册目录放一个 <id>.yaml。"
			}),
			ids.map((id) => {
					...
					children: [
							...
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									style: {
										...
										fontWeight: 600,
										fontFamily: "Consolas, Menlo, monospace",
										opacity: entry.enabled === false ? .5 : 1
									},
									children: id
								}),
								...
								entry.enabled === false && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									style: chipStyle,
									children: "已停用"
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
										...
										onChange: (event) => setEntries({
											...
											[id]: {
												...entry,
												enabled: event.target.checked ? void 0 : false
											}
										})
									}), "启用"]
								}),
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								style: labelStyle,
								children: "角色提示词"
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(AutoTextarea, {
								value: entry.persona ?? "",
								onChange: (event) => setEntries({
									...entries,
									[id]: {
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					"配置存储于名册目录 ",
					view.dir || "~/.dsh/subagents",
					"（每具名子代理一个 <id>.yaml，可手编、热生效；",
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("code", { children: "_" }),
					" 前缀的文件/目录为非名册内容，如 ",
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("code", { children: "_backups/" }),
					" 备份区）。 settings.yaml 中的旧 entries 仅作迁移兜底读取，文件优先生效。"
				]
			})
		]
	});
