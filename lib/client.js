		...
		children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					style: hintStyle,
					children: "管理具名角色子代理。保存即写名册文件并热生效：模型可在任意会话通过 list_subagents / delegate 使用。"
				})]
			}),
			(view.diagnostics?.length ?? 0) > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				style: {
					...
					gap: "2px",
					padding: "8px 10px",
					border: "1px solid var(--dsh-color-warning, #f5a623)",
					borderRadius: "6px",
					fontSize: "12px"
				},
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					"（每具名子代理一个 <id>.yaml，可手编、热生效）。 settings.yaml 中的旧 entries 仅作迁移兜底读取，文件优先生效。"
				]
			})
		]
	});
